...
const Index = () => {
  ...
  return (
    <div className="h-screen w-full bg-brand-white flex flex-col items-center justify-center overflow-hidden px-6">
      {/* Background Elements */}
      ...
      {/* Main Content */}
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center justify-center h-full py-6">
        {/* Durham College Logo */}
        <div className="mb-3">
          <DurhamLogo />
        </div>
        ...
        {/* Main Heading */}
        <h1 className="text-4xl font-bold text-brand-darkGreen text-center mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10 w-full">
          ...
          <div className="flex flex-col space-y-4">
            <h2 className="text-xl font-bold text-[#721B43] mb-3 text-center">
        ...
        {/* Footer */}
        <div className="mt-8 text-center text-sm text-brand-darkBrown/80 font-lato">
